...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('printer/test-api', [PrinterController::class, 'connectToNetworkPrinters']);
    Route::get('printer/print-kitchen/{id}', [PrinterController::class, 'printKitchen']);
    // Route::get('printer/test-api', [PrinterController::class, 'connectToNetworkPrinters']);
    ...
    Route::get('/cash-register/financial-details', [CashRegisterController::class, 'getFinancialReport']);
    Route::get('/cash-register/close-register/{id?}', [CashRegisterController::class, 'getCloseRegister']);
    Route::get('/cash-register/finance-register/{id?}', [CashRegisterController::class, 'getFinance']);
    Route::post('/cash-register/close-register', [CashRegisterController::class, 'postCloseRegister']);
    Route::get('/custom-range-report', [CashRegisterController::class, 'getCustomRangeFinance']);
    ...
    Route::prefix('modules')->group(function () {
        ...
        Route::get('/data/get-tables', [Restaurant\DataController::class, 'getTables']);
        Route::get('/data/get-staff', [Restaurant\DataController::class, 'getServiceStaff']);
