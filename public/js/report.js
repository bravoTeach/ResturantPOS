$(document).ready(function() {
    ...
    register_report_table = $('#register_report_table').DataTable({
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            var value = $('#register_report_date_range').val();

            // $('.footer_action').html(`<p>${value}</p>`);
            $('.footer_action').html(
                `<button type='button' data-href="${window.location.origin}/custom-range-report?range=${value}" class='btn btn-xs btn-info btn-modal' data-container='.view_register'>
...
document.addEventListener('keydown', function (event) {
    ...
    if (keys.join('') === 'asd') {
        ...
        var myInput = document.getElementById('zone');
