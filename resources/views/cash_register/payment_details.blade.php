  ...
  <div class="col-sm-12">
    ...
    <table class="table table-condensed">
      <tr class="success">
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->total_custom_pay_1 / (1 + 0.13) }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->total_custom_pay_1 - $register_details->total_custom_pay_1 / (1 + 0.13) }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
