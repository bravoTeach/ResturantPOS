    ...
    <div class="modal-content">
      ...
      <table style="border-bottom: 3px solid black" class="table table-condensed">
        ...
        <tr class="success">
          ...
          <td class="myfont">
            <b><span class="display_currency" data-currency_symbol="true">{{ ($details['transaction_details']->total_sales - $register_details->total_custom_pay_1 - $register_details->total_expense) }}</span></b>
          </td>
        </tr>
      </table>
