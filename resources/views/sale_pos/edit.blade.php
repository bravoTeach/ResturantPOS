		...
		<div class="col-md-12">
			<div class="row">
				<div class="@if(empty($pos_settings['hide_product_suggestion'])) col-md-7 @else col-md-10 col-md-offset-1 @endif no-padding pr-12">
					...
					<a href="{{action([\App\Http\Controllers\SellPosController::class, 'destroy'], ['po' => $transaction->id])}}" class="small-box-footer delete-sale bg-red is_suspended" style="text-align: center;padding: 10px;float: right;">
						Delete Sale <i class="fas fa-trash"></i>
					</a>
					<p style="display: none" id="myOrderDate">{{$transaction->created_at}}</p>
...
@include('sale_pos.partials.password_modal')
