...
<div class="row">
	...
	<div class="col-md-4">
		<div class="form-group">
			{!! Form::number('custom_field_4', 0, ['class' => 'form-control', 'placeholder' => __('Enter No.Of Customers'), 'min' => 0]) !!}
		</div>
		</div>
    ...
    @foreach($types_of_service as $key => $type)
        <label class="tile">
            {!! Form::radio('types_of_service_id', $key, null, ['class' => 'tile-radio', 'id' => 'types_of_service_' . $key]) !!}
