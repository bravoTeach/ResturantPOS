...
<div class="modal fade" tabindex="-1" role="dialog" id="card_details_modal">
	<div class="modal-dialog" role="document">
		...
		<div class="col-md-3">
			<div class="form-group">
				{!! Form::label("card_type", __('lang_v1.device_name')) !!}
				{!! Form::select("", ['Keenu' => 'Keenu', 'Mezan' => 'Meezan', 'Alfalah' => 'Alfalah'], 'Meezan',['class' => 'form-control select2', 'id' => "card_type" ]); !!}
			</div>
		</div>
		<div class="clearfix"></div>
		<div class="col-md-3">
			<div class="form-group">
				{!! Form::label("card_type", __('lang_v1.bank_name')) !!}
				{!! Form::select("", ['Meezen' => 'Meezan Bank', 'MCB' => 'MCB', 'Alfalah' => 'Alfalah'], 'Meezan',['class' => 'form-control select2', 'id' => "card_type" ]); !!}
			</div>
		</div>
		<div class="col-md-4">
			<div class="form-group">
