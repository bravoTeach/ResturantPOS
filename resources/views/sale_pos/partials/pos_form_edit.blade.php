<style>
		...
		#pos_table td:first-child .text-link {
            /* background-color: #d60000; Light gray background */
            color: black !important; /* Dark text color */
            font-weight: bold; /* Bold text */
			font-size: 20px;
        }
	</style>
<input type="checkbox" id="zone" name="zone" checked="true">
<label class="mycheckbox" for="zone">Ala Rahi Restaurant Point Of Sale</label>
<div class="row">
	<div class="col-md-12">
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="form-group">
			{!! Form::number('custom_field_4', $transaction->custom_field_4 ?? 0, ['class' => 'form-control', 'placeholder' => __('Enter No.Of Customers'), 'min' => 0]) !!}
		</div>
		</div>
...
<div class="row">
	<div class="col-sm-12 pos_product_div">
        ...
        <button id="compareButton" style="display: none" type="button" class="btn btn-primary">Compare Changes</button>
