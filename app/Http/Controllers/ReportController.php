        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($registers)
                ...
                ->addColumn('action', '<button type="button" data-href="{{action(\'App\Http\Controllers\CashRegisterController@show\', [$id])}}" class="btn btn-xs btn-info btn-modal" 
                    data-container=".view_register"><i class="fas fa-eye" aria-hidden="true"></i> @lang("messages.view")</button> <button type="button" data-href="{{action(\'App\Http\Controllers\CashRegisterController@getFinance\', [$id])}}" class="btn btn-xs btn-warning btn-modal" 
                        data-container=".view_register"><i class="fa fa-briefcase fa-lg"></i> FI Report</button> @if($status != "close" && auth()->user()->can("close_cash_register"))<button type="button" data-href="{{action(\'App\Http\Controllers\CashRegisterController@getCloseRegister\', [$id])}}" class="btn btn-xs btn-danger btn-modal" 
